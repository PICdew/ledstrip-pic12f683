...
#define	IR_RC6_SUPPORT		0
#define	IR_NEC_SUPPORT		1
#define	IR_JVC_SUPPORT		0
#define	IR_SONY_SUPPORT		0
#define IR_SHARP_SUPPORT	0
#define IR_PACE_SUPPORT		0
 ...
 */
 ...
 #define	NEC_FIRST_MIN		58
 #define	NEC_FIRST_MAX		61
 #define	NEC_SECOND_MIN		27 // passt genau für diesen RC-OSC 25.7°C
 #define	NEC_SECOND_MAX		31 // passt genau für diesen RC-OSC 25.7°C
 #define	NEC_SHORT_MIN		3
 #define	NEC_SHORT_MAX		5
 #define	NEC_LONG_MIN		9
 #define	NEC_LONG_MAX		12
 #define	NEC_TIMEOUT		85
